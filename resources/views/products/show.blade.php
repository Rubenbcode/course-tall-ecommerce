        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <a class="text-orange-500 underline mx-6 hover:text-orange-600" href="">39 reseñas</a>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class=" text-gray-500">Recibelo el {{Date::now()->addDays(7)->locale('es')->format('l j F')}}</p>
